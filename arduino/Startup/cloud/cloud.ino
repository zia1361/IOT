...
String apiKey = "7CGLGYEL7E6JKVW9";     // replace with your channel's thingspeak WRITE API key

String ssid="taptaan";    // Wifi network SSID
String password ="letscodecsharp";  // Wifi network password
